-- WatchMe Supabase Schema Migration (fixed)
...
create index if not exists idx_titles_published on titles(is_published);
...
create index if not exists idx_titles_countries on titles using gin(countries);
create index if not exists idx_titles_mood_tags on titles using gin(mood_tags);
create index if not exists idx_titles_categories on titles using gin(categories);
create index if not exists idx_titles_average_rating on titles(average_rating desc);
...
create index if not exists idx_comments_title on comments(title_id);
...
create index if not exists idx_reasoning_title on reasoning_tags(title_id);
...
create index if not exists idx_watchlist_profile on watchlist_items(profile_id);
...
create index if not exists idx_chat_title on chat_messages(title_id);
